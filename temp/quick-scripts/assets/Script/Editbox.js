(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/Script/Editbox.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'd050dkeAcpLDatNt5NnXG/O', 'Editbox', __filename);
// Script/Editbox.js
...
cc.Class({
    ...
    signedUp: function signedUp(clicked) {
        if (clicked) {
            cc.log('Run');
    ...
    validaterPass: function validaterPass(str) {
        var format = /[ `!@#$%^&*()_+\-=\[\]{};':"\\|,.<>\/?~]/;
        var lower = /[a-z]/;
        var upper = /[A-Z]/;
        var number = /[0-9]/;
